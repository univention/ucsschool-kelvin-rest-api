...
* The `Swagger`_ UI for a specific version:
  ...
  * ``https://<fqdn>/ucsschool/kelvin/v2/docs``
* The `ReDoc`_ UI for a specific version:

  * ``https://<fqdn>/ucsschool/kelvin/v1/redoc``
  * ``https://<fqdn>/ucsschool/kelvin/v2/redoc``
...
* ``https://<fqdn>/ucsschool/kelvin/openapi-v2.json``
