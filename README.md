...
- [ ] Update version in [docs/conf.py](./docs/conf.py)
...
- In the provider portal set the docker image to `gitregistry.knut.univention.de/univention/components/ucsschool-kelvin-rest-api:latest`.
