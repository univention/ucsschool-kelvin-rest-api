...
## -*- coding: utf-8 -*-
## desc: Test performance of wildcard search GET /ucsschool/kelvin/<version>/workgroups/?name=*
...
test_parameter = PerformanceTestParameters(
    target_locust_class="SearchWorkGroups",
    target_locust_file_name="workgroups.py",
    route="workgroups/",
    result_files_name="032-search-workgroups",
