...
## -*- coding: utf-8 -*-
## desc: Test performance of GET /ucsschool/kelvin/<version>/classes/CLASS
...
test_parameter = PerformanceTestParameters(
    target_locust_class="GetClass",
    target_locust_file_name="classes.py",
    route="classes/",
    result_files_name="021-get-class",
