...
## -*- coding: utf-8 -*-
## desc: Test performance of wildcard search GET /ucsschool/kelvin/<version>/classes/?name=*
...
test_parameter = PerformanceTestParameters(
    target_locust_class="SearchClasses",
    target_locust_file_name="classes.py",
    route="classes/",
    result_files_name="022-search-classes",
